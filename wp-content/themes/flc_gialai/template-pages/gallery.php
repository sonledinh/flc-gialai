<?php /* Template Name: Hình ảnh */ ?>
<?php get_header(); ?>

<main id="cate-body">
    <section class="banner-bread">
        <div class="avarta-bread"><img src="<?php echo get_field('avr_banner')['url'] ?>" class="img-fluid w-100" alt=""></div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="head-cate-title">
                            <h2><?php the_field('title_gall') ?></h2>
                            <div class="desc">
                                <?php the_field('sort_desc_gall') ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <?php $gall = 1; ?>
                    <?php while ( has_sub_field('content_gall' )) : ?>
                        <div class="col-md-4">
                            <div class="item-cate">
                                <div class="avarta"><a href="javascript:void(0)" data-toggle="modal" data-target="#myModal-<?php echo $gall++ ?>"><img src="<?php echo get_sub_field('avar_item_gall')['url'] ?>" class="img-fluid w-100" alt=""></a></div>
                                <div class="info">
                                    <h3><a href="javascript:void(0)"><?php the_sub_field('title_item_gall') ?></a></h3>
                                </div>
                            </div>
                        </div> 
                    <?php endwhile; ?>
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="content-popup">
                                ...
                                <div class="avarta-popup-gall text-center"><img src="<?php echo get_sub_field('avar_item_gall')['url'] ?>" class="img-fluid" alt=""></div>
                                <div class="desc">
                                    <h3><?php the_sub_field('title_item_gall') ?></h3>
                                    <div class="desc">
                                        <?php the_sub_field('content_item_gall') ?>
                                    </div>
                                </div>
                            </div>
                        </div>
